 ...
 * @returns 识别结果
 */
export async function recognizeEnglishFromImage(imagePath: string): Promise<OcrResult> {
...
export function useOcr() {
   ...
   * 从图片识别英文
   */
  const recognizeFromImage = async (imagePath: string): Promise<OcrResult | null> => {
    try {
